/**
 * @module Dash.Routing.Router
 * @author rui.carmo AT sapo.pt
 * @version 1
 */
Ink.createModule(
    'Dash.Routing.Router', // full module name
    '1',                   // module version
    ...
    function() {           // this fn will be called asynchronously with dependencies as arguments
        ...
        /**
         * Pushstate router based on routie (https://github.com/jgallen23/routie
         *
         * @class Dash.Routing.Route
         * @static
         */
