( function(){
    ...
    Ink.requireModules(['Ink.Dom.Element_1','Ink.Dom.Selector_1', 'Ink.Dom.Loaded_1', 'Ink.Util.Array_1', 'Ink.UI.SmoothScroller_1'],
                       function( Element, Selector, Loaded, InkArray, Scroller ){
        Loaded.run(function(){
